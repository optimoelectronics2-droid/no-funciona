...
function Header({ company, title }) {
  const logoUrl = company?.logoUrl || '/trifusion-logo.png'
  return (
...
function ValidationSeal() {
  return (
    <div className="invoice-validation" aria-label="Sello de validacion digital Trifusion Technologies">
      <img src="/sello-real.png" width="531" height="531" alt="Sello Trifusion Technologies" className="invoice-legal-stamp" />
    </div>
  )
}
